...
try: 
    ...
    browser.execute_script("return arguments[0].scrollIntoView(true);", imtherobot_checkbox)
    imtherobot_checkbox.click()

    browser.execute_script("return arguments[0].scrollIntoView(true);", robotsrule_radiobutton)
